...
const slides = [
  {
    desktop: "/images/banner/web1.webp",
    mobile: "/images/banner/mob1.webp",
  },
  {
    desktop: "/images/banner/web2.webp",
    mobile: "/images/banner/mob2.webp",
  },
];
...
export default function HeroSection({ onCtaClick }: HeroSectionProps) {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      {/* =========================================================
          PREVIOUS HERO CONTENT — COMMENTED OUT AS REQUESTED
      ========================================================= */}
        ...
        <div className="w-full max-w-2xl">
          ...
          >
            <div className="flex flex-col">
              ...
              <span className="text-[16px] text-white/40 font-body">
                Years Legacy
              </span>
            </div>
          ...
          >
            <button onClick={onCtaClick} className="luxury-button">
              Book A Site Visit
            </button>
          </motion.div>
        </div>
      ...
      */}
      ...
      {/* =========================================================
          PREVIOUS SCROLL INDICATOR — COMMENTED OUT
      ========================================================= */}
      ...
      >
        <span className="text-[10px] uppercase tracking-[0.4em] text-white/30 [writing-mode:vertical-lr]">
          Scroll
        </span>
